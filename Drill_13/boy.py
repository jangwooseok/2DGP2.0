...
class WalkingState:
    ...
    def do(boy):
        ...
        boy.y = clamp(80, boy.y, 1100)
        minX = (boy.y + 51) * 17 / 102
        maxX = (boy.y - 21176) * -17 / 102 - 1700
        print(maxX)
        boy.x = clamp(minX, boy.x, maxX)
    ...
    def draw(boy):
        ...
        #cx, cy = boy.x - boy.bg.canvas_left, boy.y - boy.bg.canvas_bottom
